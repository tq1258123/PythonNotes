...
>刚开始就直接进入`Python`程序学习可能会比较枯燥，所以在开始学习之前先介绍几个有趣的小程序，可能对于新手来说会更有趣。刚开始接触可能看不懂，可以先把代码复制到`pycharm`里运行一遍，看看运行结果。
...
![正方形](D:\repository\PythonNotes\notes\第6章 Python\第2节 Python基础篇\images\正方形.png)
...
![五星红旗](D:\repository\PythonNotes\notes\第6章 Python\第2节 Python基础篇\images\五星红旗.jpg)