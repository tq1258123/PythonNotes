...
所谓**字符串**，就是由零个或多个字符组成的有限序列，一般记为![formula_2](D:\repository\PythonNotes\images\formula_2.png)。在`Python`程序中，如果我们把单个或多个字符用单引号或者双引号包围起来，就可以表示一个字符串。

```Python
s1 = 'hello, world!'
s2 = "hello, world!"
# 以三个双引号或单引号开头的字符串可以折行,或者用于注释
s3 = """
hello, 
world!
"""
...
![formula_3](D:\repository\PythonNotes\images\formula_3.png)

![formula_4](D:\repository\PythonNotes\images\formula_4.png)

![formula_5](D:\repository\PythonNotes\images\formula_5.png)

![fibonacci-blocks](D:\repository\PythonNotes\images\fibonacci-blocks.png)
